...
describe('signup', () => {
  ...
  // });
  // test('should 401 when user is null and undefined', async () => {
  //   const req = mockRequest();
  //   const res = mockResponse();
  ...
  //   //   email: 'akshathamn1@gmail.com',password: 'aksh1234' 
  //   // });
  // });
  test('should 200 if user exists', () => {
    expect.assertions(1);
    const req = mockRequest( {email: 'jesttest3@gmail.com',password: 'aksh1234'} );
    const res = mockResponse();
    userController.signup(req, res)
